...
def load_chiral_data(val_mollist, speciesmap, setNatoms=29, setNviews=29, carbonbased= False, not_hydrogen= False, heaviest_origin= False,verbose=0):
    species = set()
    Natomslist = [len(mol) for mol in val_mollist]
    for mol in val_mollist:
    ...
    if verbose:
        print(f"{len(val_mollist)} molecules will be processed.")
